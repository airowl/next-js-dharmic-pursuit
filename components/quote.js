...
export default function Quote(){
    return(
        <section id="about-us" className="w-screen md:h-screen md:flex md:flex-row-reverse md:grow md:items-center pb-24 bg-main">
          <div className="container mx-auto">
            <div className="shape-a md:w-1/2 overflow-hidden relative w-full">
              ...
              <div className="px-10 mt-10 md:w-1/2 text-white">
