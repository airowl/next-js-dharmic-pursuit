            ...
            <nav className="bg-transparent border-gray-200 px-4 lg:px-6 py-2.5">
                <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                    ...
                    <div className="flex items-center lg:order-2">
                        <a
                            href="#"
                            className="text-white bg-trasparent focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 focus:outline-none border-solid border-2 border-white"
                        >
                            Get started
                        </a>
                        <button
                    ...
                    <div
                        className="justify-between items-center w-full lg:flex lg:w-auto lg:order-1 overflow-hidden"
                        id="mobile-menu-2"
                    >
                        <ul
                            className={`flex flex-col font-medium transition-all duration-300 ease-in-out bg-white md:bg-transparent lg:flex-row lg:space-x-8 lg:mt-0 ${
                                navbar ? "mt-4" : "mt-[-17rem]"
                            }`}
                        >
                            <li>
                                <Link href="/">
